export function createSpanishArquebusierModel(options: {
    ...
    const {
        coatColor = 0x3a2f2a,
        pantsColor = 0x2a2a2a,
        helmetColor = 0x3f3f3f,
        leatherColor = 0x4a2f18,
        skinColor = 0xd2c0a0,
        eyeColor = 0x111111,
        weaponColor = 0x6b4a2d,
        metalColor = 0x666666,
        scale = 1,
    } = options;
    ...
    const torso = new THREE.Mesh(
        new THREE.BoxGeometry(0.62, 1.05, 0.42),
        coatMat
    );
    ...
    const belt = new THREE.Mesh(
        new THREE.BoxGeometry(0.68, 0.12, 0.48),
        leatherMat
    );
    ...
    const crest = new THREE.Mesh(
        new THREE.BoxGeometry(0.10, 0.32, 0.05),
        helmetMat
    );
    ...
    const lock = new THREE.Mesh(
        new THREE.BoxGeometry(0.20, 0.10, 0.10),
        metalMat
    );
    ...
    leftArm.hand.add(new THREE.Mesh(
    ...
    function makeLeg(side: 1 | -1) {
        ...
        const thigh = new THREE.Mesh(
            new THREE.BoxGeometry(0.30, 0.55, 0.30),
            pantsMat
        );
        ...
        const shoe = new THREE.Mesh(
            new THREE.BoxGeometry(0.28, 0.12, 0.40),
            leatherMat
        );
