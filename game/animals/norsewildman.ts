export function createNorseWildmanModel(data, options: {
    ...
    const {
        furColor = 0x4a3a2a,   // dark fur cloak
        pantsColor = 0x3a3a3a,   // rough trousers
        skinColor = 0xc9b28f,
        hairColor = 0x3a2a1a,   // dark hair/beard
        eyeColor = 0x111111,
        woodColor = 0x6b4a2d,
        metalColor = 0x666666,
        scale = 1,
    ...
    const torso = new THREE.Mesh(
        new THREE.BoxGeometry(0.70, 1.05, 0.45),
        skinMat
    );
    ...
    const fur = new THREE.Mesh(
        new THREE.BoxGeometry(0.90, 0.70, 0.55),
        furMat
    );
    ...
    const hair = new THREE.Mesh(
        new THREE.BoxGeometry(0.48, 0.22, 0.48),
        hairMat
    );
    ...
    const blade = new THREE.Mesh(
        new THREE.BoxGeometry(0.40, 0.25, 0.08),
        metalMat
    );
    ...
    function makeLeg(side: 1 | -1) {
        ...
        const foot = new THREE.Mesh(
            new THREE.BoxGeometry(0.30, 0.12, 0.42),
            pantsMat
        );
