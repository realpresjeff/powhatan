export function createWizardModel(data, options: {
    ...
    function makeArm(side: 1 | -1) {
        ...
        const sleeve = new THREE.Mesh(
            new THREE.BoxGeometry(0.30, 0.60, 0.30),
            robeMat
        );
    ...
    // ------------------------------------------------------------
    function makeFoot(z: number) {
        const foot = new THREE.Mesh(
            new THREE.BoxGeometry(0.22, 0.10, 0.28),
            skinMat
        );
