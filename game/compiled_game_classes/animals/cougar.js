export function createCougarModel(options = {}) {
    const { coatColor = 0xA47C52, // tawny cougar color
    underbellyColor = 0xD9C5A3, muzzleColor = 0xE8DCC8, eyeColor = 0x222222, earInnerColor = 0xAA8888, scale = 1, } = options;
    ...
    cougar.add(frontLeft.group, frontRight.group, backLeft.group, backRight.group);
    // ===== TAIL =====
