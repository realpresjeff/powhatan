...
export function createBearModel(options = {}) {
    const { coatColor = 0x5a3b26, // dark brown
    muzzleColor = 0xd2b79c, // lighter muzzle
    pawColor = 0x3a2718, eyeColor = 0x111111, earInnerColor = 0x8b5a3c, scale = 1, } = options;
    ...
    bear.add(frontLeft.group, frontRight.group, backLeft.group, backRight.group);
    // ===== TAIL (small, bear nub) =====
