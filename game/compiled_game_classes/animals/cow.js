export function createCowModel(options = {}) {
    const { coatColor = 0xFFFFFF, // default dairy cow base
    spotColor = 0x000000, // black spots
    faceColor = 0xE8DCC8, hoofColor = 0x3A2F24, eyeColor = 0x111111, earInnerColor = 0xD8B8A0, hasHorns = true, hasUdders = true, scale = 1, } = options;
    ...
    cow.add(body);
    // Add a few cow spots
    function addSpot(x, y, z, sx, sy, sz) {
