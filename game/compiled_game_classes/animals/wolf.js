...
export function createWolfModel(options = {}) {
    const { coatColor = 0x666666, legColor = 0x444444, muzzleColor = 0xbbbbbb, earInnerColor = 0xaa8888, eyeColor = 0x222222, scale = 1, } = options;
    ...
    wolf.add(frontLeft.group, frontRight.group, backLeft.group, backRight.group);
