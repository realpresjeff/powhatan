export function createBeaverModel(options = {}) {
    const { bodyColor = 0x6b4a32, // beaver brown
    bellyColor = 0x8d6b50, toothColor = 0xffffff, eyeColor = 0x111111, tailColor = 0x3a2e23, scale = 1, } = options;
    ...
    // ============================================================
    const body = new THREE.Mesh(new THREE.BoxGeometry(1.1, 0.75, 0.80), bodyMat);
    body.position.set(0, 0.85, 0);
    beaver.add(body);
    // Belly patch
    const belly = new THREE.Mesh(new THREE.BoxGeometry(0.90, 0.40, 0.75), bellyMat);
    belly.position.set(0, -0.15, 0);
    body.add(belly);
    // ============================================================
    // HEAD — box + cheek spheres (rounded but stylized)
    // ============================================================
    const head = new THREE.Mesh(new THREE.BoxGeometry(0.70, 0.55, 0.60), bodyMat);
    ...
    // MUZZLE + BEAVER TEETH
    // ============================================================
    const muzzle = new THREE.Mesh(new THREE.BoxGeometry(0.35, 0.25, 0.40), bellyMat);
    ...
    function makeEar(mirror = 1) {
        const ear = new THREE.Mesh(new THREE.BoxGeometry(0.20, 0.20, 0.20), bodyMat);
    ...
    function makeLeg(x, z) {
        ...
        const upper = new THREE.Mesh(new THREE.BoxGeometry(0.30, 0.35, 0.30), bodyMat);
        upper.position.set(0, -0.18, 0);
        const paw = new THREE.Mesh(new THREE.BoxGeometry(0.32, 0.15, 0.32), bellyMat);
    ...
    // ============================================================
    const tail = new THREE.Mesh(new THREE.BoxGeometry(0.50, 0.15, 1.10), tailMat);
