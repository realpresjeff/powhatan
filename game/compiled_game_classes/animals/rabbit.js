export function createRabbitModel(options = {}) {
    const { furColor = 0xffffff, bellyColor = 0xf2f2f2, earInnerColor = 0xf0c2c2, eyeColor = 0x111111, noseColor = 0x222222, pawColor = 0x333333, scale = 1, } = options;
    ...
    // ============================================================
    const body = new THREE.Mesh(new THREE.SphereGeometry(0.6, 16, 16), furMat);
    ...
    // HEAD — round and cute
    // ============================================================
    const head = new THREE.Mesh(new THREE.SphereGeometry(0.42, 16, 16), furMat);
    head.position.set(0.0, 1.0, 0.25);
    rabbit.add(head);
    // Nose
    const nose = new THREE.Mesh(new THREE.SphereGeometry(0.07, 8, 8), noseMat);
    ...
    function makeLeg(x, z) {
        const leg = new THREE.Mesh(new THREE.BoxGeometry(0.22, 0.30, 0.22), pawMat);
    ...
    // TAIL — visible puff
    // ============================================================
    const tail = new THREE.Mesh(new THREE.SphereGeometry(0.22, 12, 12), furMat);
