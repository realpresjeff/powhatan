export function createOwlModel(options = {}) {
    ...
    // BODY — plump owl body
    // ============================================================
    const body = new THREE.Mesh(new THREE.SphereGeometry(0.55, 18, 18), bodyMat);
    body.position.set(0, 0.7, 0);
    owl.add(body);
    // Chest puff
    const chest = new THREE.Mesh(new THREE.SphereGeometry(0.48, 18, 18), bodyMat);
    chest.position.set(0.12, 0.62, 0.10);
    owl.add(chest);
    // ============================================================
    // HEAD — large round owl head
    // ============================================================
    const head = new THREE.Mesh(new THREE.SphereGeometry(0.40, 18, 18), bodyMat);
    head.position.set(0.45, 1.13, 0);
    owl.add(head);
    // ============================================================
    // FACIAL DISK — signature owl circle
    // ============================================================
    const disk = new THREE.Mesh(new THREE.SphereGeometry(0.39, 18, 18), faceMat);
    ...
    // BEAK — small triangle
    // ============================================================
    const beak = new THREE.Mesh(new THREE.ConeGeometry(0.08, 0.25, 10), beakMat);
    ...
    function makeWing(mirror = 1) {
        const wing = new THREE.Mesh(new THREE.BoxGeometry(0.16, 0.70, 0.26), wingMat);
    ...
    // ============================================================
    const tail = new THREE.Mesh(new THREE.BoxGeometry(0.24, 0.50, 0.18), wingMat);
    ...
    function makeLeg(zOffset) {
        ...
        const thigh = new THREE.Mesh(new THREE.BoxGeometry(0.16, 0.22, 0.16), legMat);
        thigh.position.set(0, -0.12, 0);
        const foot = new THREE.Mesh(new THREE.BoxGeometry(0.28, 0.10, 0.16), legMat);
