export function createTriceratopsModel(options = {}) {
    const { bodyColor = 0x7b8f6a, // green-brown
    frillColor = 0x8f6b4a, // darker frill
    hornColor = 0xe8e2d6, // ivory
    bellyColor = 0x9fb08a, eyeColor = 0x111111, scale = 1, } = options;
    ...
    // ------------------------------------------------------------
    const body = new THREE.Mesh(new THREE.BoxGeometry(3.0, 1.2, 1.4), bodyMat);
    body.position.set(0, 1.2, 0);
    tri.add(body);
    const belly = new THREE.Mesh(new THREE.BoxGeometry(2.8, 0.45, 1.3), bellyMat);
    belly.position.set(0, -0.35, 0);
    body.add(belly);
    // ------------------------------------------------------------
    // NECK
    // ------------------------------------------------------------
    const neck = new THREE.Mesh(new THREE.BoxGeometry(0.7, 0.7, 0.7), bodyMat);
    neck.position.set(1.7, 1.35, 0);
    tri.add(neck);
    // ------------------------------------------------------------
    // HEAD — big skull
    // ------------------------------------------------------------
    const head = new THREE.Mesh(new THREE.BoxGeometry(0.9, 0.6, 0.7), bodyMat);
    head.position.set(2.3, 1.45, 0);
    tri.add(head);
    // Beak / snout
    const beak = new THREE.Mesh(new THREE.BoxGeometry(0.35, 0.30, 0.45), bodyMat);
    ...
    // ------------------------------------------------------------
    const frill = new THREE.Mesh(new THREE.BoxGeometry(0.25, 1.0, 1.3), frillMat);
    frill.position.set(-0.55, 0.10, 0);
    head.add(frill);
    // ------------------------------------------------------------
    // HORNS — three horns (2 brow + 1 nose)
    // ------------------------------------------------------------
    function makeHorn(x, y, z, len) {
        const horn = new THREE.Mesh(new THREE.CylinderGeometry(0.10, 0.16, len, 10), hornMat);
    ...
    function makeLeg(x, z) {
        ...
        const upper = new THREE.Mesh(new THREE.BoxGeometry(0.55, 1.0, 0.55), bodyMat);
        upper.position.set(0, -0.5, 0);
        const foot = new THREE.Mesh(new THREE.BoxGeometry(0.65, 0.28, 0.65), bodyMat);
    ...
    // TAIL — short, heavy
    // ------------------------------------------------------------
    const tail = new THREE.Mesh(new THREE.BoxGeometry(0.8, 0.35, 0.35), bodyMat);
