export function createElkModel(options = {}) {
    ...
    // ============================================================
    function createElkAntler(isLeft) {
        ...
        root.add(beam);
        // tines
        function addTine(x, y, z, length = 0.45) {
            const t = new THREE.Mesh(new THREE.BoxGeometry(length, 0.12, 0.12), antlerMat);
