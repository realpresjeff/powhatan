export function createRatModel(options = {}) {
    const { bodyColor = 0x6b6b6b, // gray rat
    bellyColor = 0x8a8a8a, earColor = 0x9a7a7a, // pinkish ears
    eyeColor = 0x111111, tailColor = 0x8a6a6a, scale = 1, } = options;
    ...
    // ------------------------------------------------------------
    const body = new THREE.Mesh(new THREE.SphereGeometry(0.45, 14, 14), bodyMat);
    body.scale.set(1.4, 1.0, 0.9);
    body.position.set(0, 0.55, 0);
    rat.add(body);
    // Belly
    const belly = new THREE.Mesh(new THREE.SphereGeometry(0.38, 12, 12), bellyMat);
    ...
    // ------------------------------------------------------------
    const head = new THREE.Mesh(new THREE.SphereGeometry(0.30, 14, 14), bodyMat);
    head.position.set(0.60, 0.70, 0);
    rat.add(head);
    // Snout
    const snout = new THREE.Mesh(new THREE.BoxGeometry(0.30, 0.20, 0.20), bodyMat);
    snout.position.set(0.28, -0.05, 0);
    head.add(snout);
    // Nose
    const nose = new THREE.Mesh(new THREE.SphereGeometry(0.05, 8, 8), earMat);
    ...
    function makeEar(side) {
        const ear = new THREE.Mesh(new THREE.SphereGeometry(0.14, 10, 10), earMat);
    ...
    function makeLeg(x, z) {
        ...
        const upper = new THREE.Mesh(new THREE.BoxGeometry(0.12, 0.20, 0.12), bodyMat);
        upper.position.set(0, -0.10, 0);
        const foot = new THREE.Mesh(new THREE.BoxGeometry(0.16, 0.08, 0.20), bodyMat);
    ...
    // ------------------------------------------------------------
    const tail = new THREE.Mesh(new THREE.CylinderGeometry(0.05, 0.02, 1.6, 10), tailMat);
