export function bag() {
    ...
    const bagBody = new THREE.Mesh(new THREE.BoxGeometry(1.8, 2.4, 1.2), this.materialDarkest);
    bagBody.position.set(0, -0.6, -2.4);
    bag.add(bagBody);
    const strapLeft = new THREE.Mesh(new THREE.BoxGeometry(0.3, 2.6, 0.3), this.materialDark);
