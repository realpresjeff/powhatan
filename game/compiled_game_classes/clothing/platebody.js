export function platebody() {
    ...
    // BACK PLATE
    // -------------------------------
    const backPlate = new THREE.Mesh(new THREE.BoxGeometry(3.4, 3.0, 0.6), ironMaterial);
    ...
    // -------------------------------
    const frontPlate = new THREE.Mesh(new THREE.BoxGeometry(3.2, 3.0, 0.7), ironMaterial);
    ...
    // -------------------------------
    const chestBlock = new THREE.Mesh(new THREE.BoxGeometry(3.4, 3.0, 1.2), ironMaterial);
    ...
    // BELT PLATE
    // -------------------------------
    const beltPlate = new THREE.Mesh(new THREE.BoxGeometry(3.5, 0.5, 1.2), ironMaterial);
