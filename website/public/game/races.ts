...
type Mestizo = [Base_Race.European, Base_Race.Native_American];
type Zambo = [Base_Race.African, Base_Race.Native_American];
type Mulatto = [Base_Race.European, Base_Race.African];
type OtherMixedRace = [Base_Race.Native_American, Base_Race.African, Base_Race.European | Base_Race.Asian]; // Example of a more complex mix
...
interface Race {
  ...
  region: string;
  description: string;
  base_race: Base_Race | Mestizo | Zambo | Mulatto | OtherMixedRace;
  base_stat_boost: string[];
  pilgrim_origin?: Pilgrim_Origin; // Optional for Pilgrims
}

// Define available skills for boosts
const skill_boosts: string[] = [
...
const race_stat_boosts: { [key: string]: string[] } = {
...
const pilgrim_boosts: { [key in Pilgrim_Origin]: string[] } = {
...
function get_random_boost(boost_list: string[]): string {
